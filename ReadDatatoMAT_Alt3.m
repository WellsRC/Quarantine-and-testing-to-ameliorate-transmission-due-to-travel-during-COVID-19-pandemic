...
pA=[81.91 77.59 77.59 69.46 69.46 (64.54.*w60to79+35.44.*w80p)]./100;
    ...
    save(['Country_Data_' DateInter{1} '_Incubation=' num2str(IncubationP) '_Adherence_Level_' num2str(100) '.mat'],'prev','rec','c','N','vac','proH','avgABM','pgeoABM','VTABM','CountryM','pA','cstatusR','Vacup','VOCOmincron','VOCDelta','Demo')
