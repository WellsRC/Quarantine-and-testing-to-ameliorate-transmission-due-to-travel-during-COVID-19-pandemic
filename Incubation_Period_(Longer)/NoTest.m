...
parfor jj=1:15 
    ...
    RQSN(jj)=((1./ts).*integral2(@(u,t)InfectiousnessfromInfectionTesting(t+u,u,[],testtype,R0S,R0A,0,ts,tL,td,0,betaRTPCR),0,max(ts-qA(jj),0),qA(jj),inf));
...
save(['Longer_Incubation_NoTest.mat']);
clear;