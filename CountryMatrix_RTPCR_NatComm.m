...
cFile={'NatComm-Quarantine_RTPCR_Exit_Duration'};
...
print(gcf,['Figure_Country_No_VOC_RTPCR_NatComm.png'],'-dpng','-r600');
print(gcf,['FigureS15.png'],'-dpng','-r600');
save('NatComm-RTPCR-Country-Full.mat');