...
Date=[datenum('January 6,2021'):7:datenum('August 29 ,2021')]';
...
V1=zeros(length(V1temp(:,1)),8);
V2=zeros(length(V1temp(:,1)),8);
% 0-19
...
% 60-69
V1(:,6)=(V1temp(:,10).* T.age60(tA)+V1temp(:,11).* T.age65(tA))./Test(6);
V2(:,6)=(V2temp(:,10).* T.age60(tA)+V2temp(:,11).* T.age65(tA))./Test(6);


% 70-79
V1(:,7)=(V1temp(:,12).* T.age70(tA)+V1temp(:,13).* T.age75(tA))./Test(7);
V2(:,7)=(V2temp(:,12).* T.age70(tA)+V2temp(:,13).* T.age75(tA))./Test(7);

% 80-100
V1(:,8)=(V1temp(:,14).* T.age80(tA)+V1temp(:,15).* T.age85(tA)+V1temp(:,16).* (T.age90(tA)+T.age95(tA)+T.age100(tA)))./Test(8);
V2(:,8)=(V2temp(:,14).* T.age80(tA)+V2temp(:,15).* T.age85(tA)+V2temp(:,16).* (T.age90(tA)+T.age95(tA)+T.age100(tA)))./Test(8);
