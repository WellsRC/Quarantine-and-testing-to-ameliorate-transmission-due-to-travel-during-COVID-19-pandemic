...
for durT=30:-1:1
    parfor jj=1:225 
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
         ...
         RQQS(jj)=((1./ts).*integral2(@(u,t)InfectiousnessfromInfectionTesting(t+u,u,[qB(jj) qA(jj)+qB(jj)+durT],testtype2,R0S,R0A,0,ts,tL,td,SelfIsolate,betaRTPCR),0,ts,qA(jj)+qB(jj)+durT,inf));
         RQQA(jj)=((1./td).*integral2(@(u,t)InfectiousnessfromInfectionTesting(t+u,u,[qB(jj) qA(jj)+qB(jj)+durT],testtype2,R0S,R0A,1,ts,tL,td,0,betaRTPCR),0,td,qA(jj)+qB(jj)+durT,inf));  
        ...
        RIQS(jj)=((1./min(ts,durT)).*integral2(@(u,t)InfectiousnessfromInfectionTesting(t+u,u,qA(jj),testtype,R0S,R0A,0,ts,tL,td,SelfIsolate,betaRTPCR),0,min(ts,durT),qA(jj),inf));
        RIQA(jj)=((1./min(td,durT)).*integral2(@(u,t)InfectiousnessfromInfectionTesting(t+u,u,qA(jj),testtype,R0S,R0A,1,ts,tL,td,0,betaRTPCR),0,min(td,durT),qA(jj),inf));   
