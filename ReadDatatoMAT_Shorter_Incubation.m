...
for nn=4:-1:4
    ...
    for ii=1:NM-1
        for jj=(ii+1):NM        
            [prevA,prevB,vacupA,vacupB,proHA,proHB,recA,recB,cA,cB,NA,NB,avgdAB,pgeoAB,VTAB,avgdBA,pgeoBA,VTBA,CAstatusR,~,VacupA,~,VOCBetaGH501YV2A,~,VOCAlpha20201201GRYA,~,VOCDeltaG478KV1A,~,DemoA,DemoB] = CountryDataReturnShortIncubation({'June 27, 2021'},CountryM(ii),CountryM(jj),pA,AL);
    ...
    save(['Shorter_Incubation_Country_Data_June_27_2021_Adherence_Level_' num2str(nn*25) '.mat'],'prev','rec','c','N','vac','proH','avgABM','pgeoABM','VTABM','CountryM','pA','cstatusR','Vacup','VOCBetaGH501YV2','VOCAlpha20201201GRY','VOCDeltaG478KV1','Demo')
end