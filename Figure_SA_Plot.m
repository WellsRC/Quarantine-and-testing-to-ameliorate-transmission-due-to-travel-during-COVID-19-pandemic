...
figure('units','normalized','outerposition',[0.0 0.05 1 0.6]);
    for ii=(1+3*(jj-1)):(3*jj)
        if(ii<=16)
            ...
            text(-6.4,350*0.98,['Standard deviation:' num2str(STDP(STDPI(ii)),'%4.3f')],'Fontsize',18);
            ...
            ylim([0 350])
            box off;
            set(gca,'XTick',[-15:15],'Fontsize',18,'LineWidth',2','Tickdir','out');
            xtickangle(90);
            xlabel({'Change in quarantine specified','by destination country'},'Fontsize',20','Position',[0.097490571475886,-33.51345482593172]);
            ...
            text(-8.663658536585366,371.14,char(64+ii),'Fontsize',32','FontWeight','bold');
        end
    end
