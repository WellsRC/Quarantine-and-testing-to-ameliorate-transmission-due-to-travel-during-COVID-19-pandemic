...
figure('units','normalized','outerposition',[0.0 0.05 1 0.6]);
    for ii=(1+3*(jj-1)):(3*jj)
        if(ii<=16)
            ...
            ylim([0 550])
            box off;
            set(gca,'XTick',[-15:5:15],'Xminortick','on','Fontsize',18,'LineWidth',2','Tickdir','out');
            xtickangle(90);
            ...
            text(-8.663658536585366*31/13,371.14.*550/350,char(64+ii),'Fontsize',32','FontWeight','bold');
        end
    end
