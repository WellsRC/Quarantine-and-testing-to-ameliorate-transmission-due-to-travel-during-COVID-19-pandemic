...
AL=1;
AQ=1;
load(['Traffic_NO_VOC_Quarantine_Shorter_Incubation_' cFile '_AL=' num2str(100*AL) '_AQ=' num2str(AQ*100) '_November 21, 2021.mat'],'QM');
QMG=QM;
load(['Country_NO_VOC_Quarantine_Shorter_Incubation_' cFile '_AL=' num2str(AL*100) '_AQ=' num2str(100*AQ) '_November 21, 2021.mat'],'QM','CSR');
...
print(gcf,['RTPCR_Compare_Aug8.png'],'-dpng','-r600');
...
print(gcf,['No Test_Compare_Aug8.png'],'-dpng','-r600');
...
print(gcf,['Ag Test_Compare_Aug8.png'],'-dpng','-r600');
...
print(gcf,['Dual_Ag Test_Compare_Aug8.png'],'-dpng','-r600');