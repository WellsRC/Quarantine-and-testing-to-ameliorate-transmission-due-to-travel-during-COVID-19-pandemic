function [vacup,proH] = CountryVaccinationSecondStage(vacup,tempH,rec,prev)
...
% To examine different coverages with the country
% 
% proHM=zeros(length(vacM(:,1)),length(Demo));
% [vacup,proH,vacM,proHM] = CountryVaccinationSecondStage(Demo,vacup,tempH,vacM,tempHM,rec,prev,prevM)
