...
text(-1.534999999999991+ts,0.25, num2str(round(RS,1),'%2.1f'),'Fontsize',16,'HorizontalAlignment','center');
...
text(-2.836,0.7,'E','Fontsize',32,'Fontweight','bold');
panel=2;
...
xlim([0 25]);
set(gca,'LineWidth',2,'tickdir','out','Fontsize',16,'XTick',[0:25],'XMinorTick','on','Yminortick','on','YTick',[0:0.1:0.9]);
text(-2.836,0.7,'F','Fontsize',32,'Fontweight','bold');

print(gcf,['Figure_Infectivity_11_7.png'],'-dpng','-r600');