function R = InfectiousnessfromInfectionTesting(ttemp,utemp,timet,testtype,R0S,R0A,pA,ts,tL,td,SelfIsolate,beta)
...
for jj=1:length(timet)
    SS(jj,:) = TestSensitivity(u+timet(jj),ts,tL,Std,[testtype{jj}],beta);
end
