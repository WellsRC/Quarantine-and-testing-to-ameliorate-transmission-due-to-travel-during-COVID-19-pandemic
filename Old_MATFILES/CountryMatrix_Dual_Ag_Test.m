...
cFile={'Quarantine_BDVeritor_Entry_Exit_Duration'};
...
print(gcf,['Figure_Country_No_VOC_Dual_Ag_Test.png'],'-dpng','-r600');
print(gcf,['FigureS14.png'],'-dpng','-r600');
save('Dual_Ag_Test_Country.mat');