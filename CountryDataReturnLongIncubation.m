...
[recA,NA] = RecoveredPopulationLI(CountryA,DateN,DemoA,pA,AL);
[recB,NB] = RecoveredPopulationLI(CountryB,DateN,DemoB,pA,AL);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
% Vaccination Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
% Epidata
[cA,prevA,CAstatusR] = CountryEpiDataLI(CountryA,NA,DateN,DemoA,vacupA,recA,pA,AL);
[cB,prevB,CBstatusR] = CountryEpiDataLI(CountryB,NB,DateN,DemoB,vacupB,recB,pA,AL);
