...
print(gcf,['Figure_Country_Hospital_RTPCRExit_0Day_Quarantine.png'],'-dpng','-r600');

PlotQuarantineHospitalization(CountryM,QMNT,CSR)
print(gcf,['Figure_Country_Hospital_RTPCRExit_No_Travel.png'],'-dpng','-r600');
...
print(gcf,['Figure_Country_Hospital_Relative_Reduction_No_Travel_RTPCRExit.png'],'-dpng','-r600');

RRR=(QM0-QMNT);
RRR(QM0==-1)=-1;

PlotQuarantineHospitalizationAbsReduction_NoTravel(CountryM,RRR,CSR)
print(gcf,['Figure_Country_Hospital_Absolute_Reduction_No_Travel_RTPCRExit.png'],'-dpng','-r600');