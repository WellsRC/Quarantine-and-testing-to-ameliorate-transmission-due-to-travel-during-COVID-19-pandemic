...
%         IA=InfectionsVOCAll(nageA,nageB,[1],[1],[0],[0],[0],RA,pA,d,prevA,prevB,vacupA,vacupB,recA,recB,cA,vAB,vBA,dAB,dBA,NA,NB,qA,cFile);
...
% Create arrow
annotation(gcf,'arrow',[0.534868421052632 0.325],...
    [0.558069381598793 0.463046757164404],...
    'Color',[0.650980392156863 0.650980392156863 0.650980392156863],...
    'LineWidth',2,...
    'LineStyle','--');

% Create arrow
annotation(gcf,'arrow',[0.976973684210526 0.371052631578947],...
    [0.555052790346908 0.437405731523379],...
    'Color',[0.650980392156863 0.650980392156863 0.650980392156863],...
    'LineWidth',2,...
    'LineStyle','--');
...
xtickformat(gca, 'percentage');
% xtickangle(45);
set(gca,'LineWidth',2,'tickdir','out','fontsize',16,'XTick',[25:1:30]','Xminortick','on','YTick',[0.55:0.01:0.63],'Yminortick','on','Xlim',[25 30],'Ylim',[0.55 0.63]);
box off;
...
print(gcf,['Figure6.png'],'-dpng','-r600');