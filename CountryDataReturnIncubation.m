function [prevA,prevB,vacupA,vacupB,proHA,proHB,recA,recB,cA,cB,NA,NB,avgdAB,pgeoAB,VTAB,avgdBA,pgeoBA,VTBA,CAstatusR,CBstatusR,VacupALOA,VacupALOB,VOCOmincronA,VOCOmincronB,VOCDeltaA,VOCDeltaB,DemoA,DemoB] = CountryDataReturnIncubation(Date,CountryA,CountryB,pA,AL,IncubationP)
