...
parfor jj=1:15
    ...
    RQSN(jj)=((1./ts).*integral2(@(u,t)InfectiousnessfromInfectionTesting(t+u,u,[0 qA(jj)],testtype,R0S,R0A,0,ts,tL,td,0,betaRTPCR),0,ts,qA(jj),inf));
...
save(['Quarantine_BDVeritor_Entry_Exit.mat']);